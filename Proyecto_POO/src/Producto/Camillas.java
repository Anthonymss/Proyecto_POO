...
public class Camillas extends Producto implements Idescuentable{
    int cantidad;
    ...
    public Camillas(int NumeroSerie, Categoria categoria, String Nombre, String Descripcion, double Precio, int Stock) {
        super(NumeroSerie, categoria, Nombre, Descripcion, Precio, Stock);
    }

    public Camillas(int NumeroSerie, Categoria categoria, String nombreCat, String Nombre, String Descripcion, double Precio, int Stock) {
    ...
    public double descuentoPordia(double precio, int cantidad){
        ...
        if(diaSemana().equalsIgnoreCase("Wednesday"))
        {
